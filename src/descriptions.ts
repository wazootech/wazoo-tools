...
export const DISCOVER_SCHEMA_TOOL_DESCRIPTION =
  "Explore the ontology classes, predicate relations, and graph schemas within a specified world or knowledge graph.";
